...
* **Kích hoạt Kỹ năng:**
  ...
  * **Phím 3:** **Susanoo** 🛡️ - Triệu hồi giáp bảo vệ giúp bất tử trong vòng 5 giây (có thanh thời gian hiển thị).
* **Điều khiển hệ thống:**
  * **Phím Backspace** hoặc click nút: Chơi lại khi Game Over.
  * **Nút Tạm dừng (Pause):** Tạm ngưng game.
...
* **Đồ họa 3D sinh động:** Sử dụng mô hình 3D định dạng `.glb`/`.gltf` (Nhân vật Ninja, Chướng ngại vật, môi trường núi non, cây cối).
* **Xử lý va chạm chính xác:** Tích hợp thuật toán **OBB (Oriented Bounding Box)** của Three.js để tính toán va chạm vật lý nghiêng chính xác 100%.
* **Hệ thống Kỹ năng đa dạng:** Mỗi kỹ năng đều kèm theo các hiệu ứng đồ họa đặc trưng (hào quang, lửa, sét) và âm thanh sống động.
...
* **Hệ thống Âm thanh phong phú:** Nhạc nền lôi cuốn cùng hiệu ứng âm thanh sống động khi nhặt tiền, va chạm hoặc dùng kỹ năng.
* **Chế độ Luyện tập đa dạng:** 9 mẫu thử thách từ dễ đến khó (Đá rơi, tường đá kép, ziczac chéo, phi tiêu tầm cao, thiên thạch lở, đá khổng lồ nhảy/trượt, cột gỗ, phi tiêu chìm...).
...
* **Xử lý va chạm:** Three.js OBB (Oriented Bounding Box).
* **Âm thanh:** Web Audio API & HTML5 Audio.
...
├── main.js             # Logic xử lý game chính (Renderer, Loop, Physics, Skills)
